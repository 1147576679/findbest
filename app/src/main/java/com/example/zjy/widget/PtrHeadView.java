...
public class PtrHeadView extends FrameLayout implements PtrUIHandler {

    private final static String KEY_SharedPreferences = "mystyle";
    ...
    private PtrHeadView.LastUpdateTimeUpdater mLastUpdateTimeUpdater = new PtrHeadView.LastUpdateTimeUpdater();
    ...
    public PtrHeadView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViews(attrs);
    }

    public PtrHeadView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void initViews(AttributeSet attrs) {
        ...
        buildAnimation();
        View header = LayoutInflater.from(getContext()).inflate(R.layout.pull_to_refresh_head, this);
